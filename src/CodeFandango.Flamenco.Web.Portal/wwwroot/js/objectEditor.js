var editors = (() => {
  ...
  // ts/objectEditor.ts
  var objectEditor_exports = {};
  __export(objectEditor_exports, {
    objectEditor: () => objectEditor
  });

  // ts/helpers.ts
  var helper = class {
    // function to order an array of objects by specified value of an object. It should be possible to pass this to the sort function of an array.
    static orderBy(property) {
      var sortOrder = 1;
      if (property[0] === "-") {
        sortOrder = -1;
      ...
      return function(a2, b2) {
        var result = a2[property] < b2[property] ? -1 : a2[property] > b2[property] ? 1 : 0;
  ...
  var _sidebar_instances, addToPage_fn;
  var sidebar = class {
    constructor(config) {
      __privateAdd(this, _sidebar_instances);
      __publicField(this, "element");
      __publicField(this, "Offcanvas");
      __publicField(this, "bodyElement");
      __publicField(this, "id");
      __publicField(this, "size", "xl");
      ...
      __publicField(this, "close", (force) => {
        if (force === true) {
          this.Offcanvas.hide();
          return;
        }
      ...
      __publicField(this, "show", (e2) => {
        this.Offcanvas.show();
      });
      this.rootConfig = config;
      this.id = crypto.randomUUID();
      var elementId = __privateMethod(this, _sidebar_instances, addToPage_fn).call(this);
      this.element = document.querySelector(elementId);
      this.Offcanvas = new import_bootstrap.Offcanvas(this.element);
  ...
  _sidebar_instances = new WeakSet();
  addToPage_fn = function() {
    var _a;
    var html = `<div class="offcanvas offcanvas-end w-${this.sizes[this.size]}" id="sidebar-${this.id}" data-bs-backdrop="${((_a = this.rootConfig) == null ? void 0 : _a.backdrop) || "static"}" tabindex="-1" aria-labelledby="offcanvasLabel">
  ...
  function e(e2, t2, n = document) {
    let r = new CustomEvent(`reef:${e2}`, { bubbles: true, cancelable: true, detail: t2 });
  ...
  function f(e2, t2, n, r) {
    if (!t2.startsWith("on") || !r) return;
    if (e2[t2]) return;
    let i = r[n.split("(")[0]];
    i && (e2[t2] = i);
  }
  ...
  function m(e2, t2, n, r) {
    f(e2, t2, n, r), h(t2, n) || (c.includes(t2) && (e2[t2] = "value" === t2 ? n : " "), e2.setAttribute(t2, n));
  }
  function g(e2, t2) {
  ...
  function p(e2, t2) {
    if (1 === e2.nodeType) {
      for (let { name: n, value: r } of Array.from(e2.attributes)) {
        if (h(n, r)) return g(e2, n), void f(e2, n, r, t2);
        if (!n.startsWith("@") && !n.startsWith("#")) continue;
        let i = n.slice(1);
        g(e2, n), d.includes(i) && a(r) || m(e2, i, r, t2);
      }
      if (e2.childNodes) for (let n of e2.childNodes) p(n, t2);
    }
  }
  function b(e2) {
  ...
  function y(e2, t2, n) {
    let r = e2.childNodes, i = t2.childNodes;
    (function(e3) {
      let t3 = e3.querySelectorAll("script");
      for (let e4 of t3) e4.remove();
    })(e2) || (r.forEach(function(e3, o) {
      if (!i[o]) {
        let r2 = e3.cloneNode(true);
        return p(r2, n), void t2.append(r2);
      }
      if (l = e3, s = i[o], "number" == typeof l.nodeType && l.nodeType !== s.nodeType || "string" == typeof l.tagName && l.tagName !== s.tagName || "string" == typeof l.id && l.id && l.id !== s.id || "getAttribute" in l && "getAttribute" in s && l.getAttribute("key") !== s.getAttribute("key") || "string" == typeof l.src && l.src && l.src !== s.src) {
        let r2 = function(e4, t3) {
          if (1 !== e4.nodeType) return;
          let n2 = e4.getAttribute("id"), r3 = e4.getAttribute("key");
          if (!n2 || !r3) return;
          let i2 = n2 ? `#${n2}` : `[key="${r3}"]`;
          return t3.querySelector(`:scope > ${i2}`);
        }(e3, t2);
        if (!r2) {
          let t3 = e3.cloneNode(true);
          return p(t3, n), void i[o].before(t3);
        }
        i[o].before(r2);
      }
      var l, s;
      if (r[o] && "hasAttribute" in r[o] && r[o].hasAttribute("reef-ignore")) return;
      if (function(e4, t3, n2) {
        if (1 !== e4.nodeType) return;
        let r2 = e4.attributes, i2 = t3.attributes;
        for (let { name: i3, value: o2 } of Array.from(r2)) {
          if (i3.startsWith("#")) continue;
          if (c.includes(i3) && u.includes(e4.tagName.toLowerCase())) continue;
          let r3 = i3.startsWith("@") ? i3.slice(1) : i3;
          d.includes(r3) && a(o2) ? g(t3, r3) : m(t3, r3, o2, n2);
        }
        for (let { name: e5, value: n3 } of Array.from(i2)) r2[e5] || c.includes(e5) && u.includes(t3.tagName.toLowerCase()) || g(t3, e5);
      }(e3, i[o], n), e3.nodeName.includes("-")) return;
      let f2 = b(e3);
      if (f2 && f2 !== b(i[o]) && (i[o].textContent = f2), e3.childNodes.length || !i[o].childNodes.length) {
        if (!i[o].childNodes.length && e3.childNodes.length) {
          let t3 = document.createDocumentFragment();
          return y(e3, t3, n), void i[o].appendChild(t3);
        }
        e3.childNodes.length && y(e3, i[o], n);
      } else i[o].innerHTML = "";
    }), function(e3, t3) {
      let n2 = e3.length - t3.length;
      if (!(n2 < 1)) for (; n2 > 0; n2--) e3[e3.length - 1].remove();
    }(i, r));
  }
  function v(n, r, i) {
    let o = t(n), l = function(e2) {
    ...
    e("before-render", null, o) && (y(l, o, i), e("render", null, o));
  }

  // ts/objectEditor.ts
  var objectEditorSidebar = class extends sidebar {
    constructor(config) {
      super();
      __publicField(this, "config");
      __publicField(this, "item");
      __publicField(this, "load", (id) => {
        this.config.get(id).then((x) => {
          this.item = x.model;
          this.show();
        });
      });
      __publicField(this, "newObject", () => {
        this.item = {};
        this.show();
      });
      this.config = config;
  ...
  var objectEditor = class {
    constructor(config) {
      __publicField(this, "config");
      // Add the type annotation for 'config'
      ...
      __publicField(this, "editObject", (e2) => {
        var id = e2.currentTarget.getAttribute("data-object-id");
    ...
    getDefinition() {
      return ajax.get(this.config.definitionUrl).then((x) => {
        this.definition = x.model;
      });
    }
    getList() {
      return ajax.get(this.config.listUrl).then((x) => {
        this.list = x.model;
        this.render();
      });
    }
    render() {
      ...
      html += `<table class="table table-hover">
        <thead>
            <tr>
                ${this.definition.sort((x) => helper.orderBy("order")).map((x) => `<th>${x.name}</th>`).join("")}
            </tr>
        </thead>
        <tbody>`;
      this.list.forEach((x) => {
        html += `<tr data-object-id="${x.id}">
                ${this.definition.sort((x2) => helper.orderBy("order")).map((y2) => {
          var _a;
          return `<td>${(_a = x[y2.code]) != null ? _a : ""}</td>`;
        }).join("")}
            </tr>`;
      });
      html += `</tbody></table>`;
    ...
    bind() {
      document.querySelectorAll("#editor tbody tr").forEach((x) => {
        x.removeEventListener("click", this.editObject);
        x.addEventListener("click", this.editObject);
      });
    }
  };
  return __toCommonJS(objectEditor_exports);
})();
